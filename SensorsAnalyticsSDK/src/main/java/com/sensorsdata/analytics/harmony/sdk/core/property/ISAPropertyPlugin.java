...
interface ISAPropertyPlugin {
     ...
     */
    void appendProperties(ZSONObject properties);

    /**
     * 向插件中添加动态属性
     *
     * @param properties 添加动态属性的 map 对象
     */
    void appendDynamicProperties(ZSONObject properties);
     ...
     */
    void eventTypeFilter(Set<SAEventType> eventTypeFilter);
